...
static const std::vector<KeyTranslationEntry> g_dutchClassic = {
    ...
    { Key::AltGr, false, true, false, { { Key::AltGr, false, false, false }, { Key::E }, { Key::E }, { Key::R } }, "eer.wav" },  // In non-US keyboard layouts, Windows translates AltGr to LeftCtrl+AltGr [Bug:both left and altgr key are getting locked]
    { Key::OpenBracket, false, false, false, { { Key::O }, { Key::U } }, "ou.wav" },
    { Key::CloseBracket, false, false, false, { { Key::I }, { Key::J } }, "ij.wav" },
    { Key::CloseBracket, false, true, false, { { Key::I }, { Key::J } }, "u.wav" },
    ...
    { Key::Apostrophe, false, true, false, { { Key::Apostrophe, false, false, false } } }, // Apostrophe, and Space
    { Key::Apostrophe, true, false, false, { { Key::Apostrophe, true, false, false } } }, // Shift + Apostrophe, and Space
    ...
    //{ Key::A, true, false, true, { { Key::A }, { Key::A } }, "aa.wav" }, // same structure for all the vowels with output aa
    { Key::B, false, false, false, {}, "b.wav" },
    { Key::B, true, false, false, {}, "b.wav" },
    { Key::C, false, false, false, {}, "c.wav" },
    { Key::C, true, false, false, {}, "c.wav" }, // audio is correct now, output should be upper case c
    { Key::C, false, true, false, { { Key::C } }, "k.wav" }, // this is how it should be supported
    { Key::D, false, false, false, {}, "d.wav" },
    { Key::D, true, false, false, {}, "d.wav" },
    { Key::D, false, true, false, { { Key::D } }, "t.wav" },
    { Key::E, false, false, false, {}, "e.wav" },
    { Key::E, true, false, false, {}, "e.wav" },
    //{ Key::E, true, false, true, { { Key::E }, { Key::E } }, "ee.wav" },
    { Key::E, false, true, false, { { Key::E } }, "u.wav" },
    { Key::F, false, false, false, {}, "f.wav" },
    { Key::F, true, false, false, {}, "f.wav" },
    { Key::G, false, false, false, {}, "g.wav" },
    { Key::G, true, false, false, {}, "g.wav" },
    { Key::H, false, false, false, {}, "h.wav" },
    ...
    { Key::I, false, true, false, { { Key::I } }, "u.wav" },
    { Key::J, false, false, false, {}, "j.wav" },
    { Key::J, true, false, false, {}, "j.wav" },
    { Key::K, false, false, false, {}, "k.wav" },
    { Key::K, true, false, false, {}, "k.wav" },
    { Key::L, false, false, false, {}, "l.wav" },
    { Key::L, true, false, false, {}, "l.wav" },
    { Key::M, false, false, false, {}, "m.wav" },
    { Key::M, true, false, false, {}, "m.wav" },
    { Key::N, false, false, false, {}, "n.wav" },
    ...
    { Key::Q, true, false, false, {}, "q.wav" },
    { Key::R, false, false, false, {}, "r.wav" },
    { Key::R, true, false, false, {}, "r.wav" },
    { Key::S, false, false, false, {}, "s.wav" },
    { Key::S, true, false, false, {}, "s.wav" },
    { Key::T, false, false, false, {}, "t.wav" },
    { Key::T, true, false, false, {}, "t.wav" },
    { Key::U, false, false, false, {}, "u.wav" },
    { Key::U, true, false, false, {}, "u.wav" },
    //{ Key::U, false, true, true, { { Key::U }, { Key::U } }, "uu.wav" },
    { Key::V, false, false, false, {}, "v.wav" },
    { Key::V, true, false, false, {}, "v.wav" },
    { Key::W, false, false, false, {}, "w.wav" },
    { Key::W, true, false, false, {}, "w.wav" },
    { Key::X, false, false, false, {}, "x.wav" },
    { Key::X, true, false, false, {}, "x.wav" },
    { Key::Y, false, false, false, {}, "y.wav" },
    { Key::Y, true, false, false, {}, "y.wav" },
    { Key::Y, false, true, false, { { Key::Y } }, "i.wav" },
...
static const std::vector<KeyTranslationEntry> g_dutchKWeC = {
    ...
    { Key::Minus, false, false, false, { { Key::E }, { Key::U }, { Key::R } }, "eur.wav" },
    { Key::Minus, false, true, false, { { Key::Minus, false, false, false } } },
    { Key::Slash, false, true, false, { { Key::O }, { Key::O }, { Key::R } }, "oor.wav" },
    { Key::Slash, false, true, false, { { Key::Slash, false, false, false } } },
    { Key::Equal, false, false, false, { { Key::S }, { Key::C }, { Key::H } }, "sch.wav" },
    { Key::Equal, false, true, false, { { Key::Equal, false, false, false } } },
    { Key::Ins, false, false, false, { { Key::A }, { Key::A }, { Key::I } }, "aai.wav" },
